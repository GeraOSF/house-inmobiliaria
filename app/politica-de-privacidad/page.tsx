export default function Page() {
  return (
    <main className="mx-auto max-w-screen-md">
      ...
      <p className="py-2">Last updated: July 28, 2024</p>
      <p className="py-2">
      ...
      <h2 className="pt-2 text-xl font-bold">Interpretation and Definitions</h2>
      ...
      <ul className="list-disc">
        ...
        <li>
          <p className="py-2">
            ...
            this Agreement) refers to House Inmobiliaria.
          </p>
        </li>
        <li>
          <p className="py-2">
        ...
        <li>
          <p className="py-2">
            <strong>Website</strong> refers to House Inmobiliaria, accessible
            from{" "}
            <a
              href="https://housemx.com/"
      ...
      <h2 className="pt-2 text-xl font-bold">Children's Privacy</h2>
      <p className="py-2">
      ...
      <h2 className="pt-2 text-xl font-bold">Links to Other Websites</h2>
      <p className="py-2">
      ...
      <h2 className="pt-2 text-xl font-bold">Changes to this Privacy Policy</h2>
      <p className="py-2">
      ...
      <h2 className="pt-2 text-xl font-bold">Contact Us</h2>
      <p className="py-2">
        If you have any questions about this Privacy Policy, You can contact us:
      </p>
      <ul className="list-disc">
        <li>By email: gerardogomezromero175@gmail.com</li>
      </ul>
    </main>
  );
}
